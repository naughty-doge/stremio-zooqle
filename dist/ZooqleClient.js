...
let _needle = _interopRequireDefault(require('needle'))

let _cheerio = _interopRequireDefault(require('cheerio'))

let _cacheManager = _interopRequireDefault(require('cache-manager'))

let _cacheManagerRedisStore = _interopRequireDefault(require('cache-manager-redis-store'))
...
class ZooqleClient {
  ...
  getItemUrl(imdbId) {
    ...
    return _asyncToGenerator(function* () {
      ...
      return _this6.cache.wrap(cacheKey, method, cacheOptions)
    })()
  }
  ...
  getMovieTorrents(imdbId) {
    ...
    return _asyncToGenerator(function* () {
      ...
      return _this7.cache.wrap(cacheKey, method, cacheOptions)
    })()
  }
  ...
  getShowTorrents(imdbId, season, episode) {
    ...
    return _asyncToGenerator(function* () {
      ...
      return _this8.cache.wrap(cacheKey, method, cacheOptions)
    })()
  }

}

let _default = ZooqleClient
